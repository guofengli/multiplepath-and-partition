...
public class Partition {
	...
	public static class PartitionMap extends Mapper<LongWritable, Text, Text, Text>{
	...
	public static class MyPartition extends Partitioner<Text, Text>{
		@Override
		public int getPartition(Text key, Text value, int numReduceeTask) {
	...
	public static class MyGroupSort extends WritableComparator{

		protected MyGroupSort() {
		...
		public int compare(Object a, Object b) {
			...
			Text key1 = (Text) a;
			Text key2 = (Text) b;
			return key1.toString().equals(key2.toString())?1:0;
		}
		
	}
	
	public static class PartitionReduce extends Reducer<Text, Text, Text, Text>{
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		FileInputFormat.addInputPath(job, new Path("/user/hive/warehouse/ares_merge/000000_0"));
